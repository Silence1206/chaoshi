...
<html>
  ...
  <c:set value="123" var="login" scope="session" />
	...
	<form name="form1" action="update?typeViewId=${list[0].pro_Id }" method="post">
			...
			<c:forEach var="list" items="${list}">
				...
				<tr bgcolor="green">
					<td>
						...
						<td >
						<input disabled="disabled" type="text" name="typeViewId"  value="${list.pro_Id}">
				...
				<tr>
					<td>
						...
						<td>
						<input type="text" name="type" value="${list.type_ID}">
					</td>
				</tr>
				<tr>
					<td>
