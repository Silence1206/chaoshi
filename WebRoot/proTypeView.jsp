...
<label>输入要查询的条件
<select name="type">
<option value="pro_Id">供应商编号
<option value="pro_Name">供应商名称
<option value="pro_Tel">联系电话
<option value="pro_Address">供应商地址
<option value="cargo_Type">供应商品类别
<option value="pro_Date">合作时间
</select>
</label>
<select name="comp">
<option value="=" selected="selected">精确查找
...
<div align="left">商家信息
			...
			<c:forEach var="list" items="${list}">
				<tr>
					...
					<td>
						...
						<a href="deletePro?typeViewId=${list.pro_Id}&typeView=${list.type_ID }">删除</a>
					</td>
				</tr>
			</c:forEach>
		</table>
		...
		<form action="newProvider?typeView=${list[0].type_ID}" method="post" name="form2">
			...
			<table border="1" align="right">
				...
				<tr>
					...
					<td>
						<input type="text" disabled="disabled" name="type" value="${list[0].type_ID}">
					</td>
				</tr>
				<tr>
				<td>
